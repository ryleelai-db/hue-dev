...
describe('databricksAutocompleteParser.js', () => {
  ...
  describe('partial removal', () => {
    it('should identify part lengths', () => {
      ...
      expect(databricksAutocompleteParser.identifyPartials('', '')).toEqual({ left: 0, right: 0 });
      expect(databricksAutocompleteParser.identifyPartials('foo', '')).toEqual({ left: 3, right: 0 });
      expect(databricksAutocompleteParser.identifyPartials(' foo', '')).toEqual({ left: 3, right: 0 });
      expect(databricksAutocompleteParser.identifyPartials('asdf 1234', '')).toEqual({
        left: 4,
        right: 0
      });
      ...
      limitChars.forEach(char => {
        ...
        expect(databricksAutocompleteParser.identifyPartials('', char + 'foo bar')).toEqual({
          left: 0,
          right: 0
        });

        expect(databricksAutocompleteParser.identifyPartials('', 'foofoo' + char)).toEqual({
          left: 0,
          right: 6
        });
